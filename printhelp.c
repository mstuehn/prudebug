...
void printhelp()
{
    ...
    printf("       when a debug file is loaded a source file line number <srcfilename>:<linenum> can be used as address\n");
    ...
    printf("    DISDBG memory_location_wa [length]\n");
    printf("    Show debug data for instruction memory location (32-bit word offset from beginning of PRU instruction memory)\n\n");

    printf("    G\n");
    printf("    Start processor execution of instructions in background - breakpoints will be disabled\n\n");

    printf("    GB\n");
    printf("    Start processor execution of instructions until breakpoint is hit\n\n");

    printf("    GSS\n");
    printf("    Start processor execution using automatic single stepping - this allows running a program with watchpoints\n\n");
    ...
    printf("    LDBG file_name\n");
    printf("    Load debug file into instruction memory\n\n");
    ...
    printf("    R [register value]\n");
    printf("    Set or display the current PRU registers.\n\n");
...
void printhelpbrief()
{
    ...
    printf("    DISDBG memory_location_wa [length] - Show debug data for instruction memory location (32-bit word offset from beginning of PRU instruction memory)\n");
    printf("    G - Start processor execution of instructions in background\n");
    printf("    GB - Start processor execution of instructions until breakpoint is hit\n");
    printf("    GSS - Start processor execution using automatic single stepping - this allows running a program with watchpoints\n");
    printf("    HALT - Halt the processor\n");
    printf("    L memory_location_iwa file_name - Load debug file into instruction memory\n");
    printf("    LDBG memory_location_iwa file_name - Load program file into instruction memory\n");
    ...
    printf("    R [register value] - Set or display the current PRU registers.\n");
